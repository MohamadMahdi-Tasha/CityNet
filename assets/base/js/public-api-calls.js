//Variables
const getReqSettings = {"method": "GET", "headers": {"Accept": "application/json", "Content-Type": "application/json"},}
const postReqSettings = {"method": "POST", "headers": {"Accept": "application/json", "Content-Type": "application/json"},}
...
fetch('https://www.newcash.me/api/v1/airfare-web/login', getReqSettings)
    .then(data => data.json())
    .then(data => {
